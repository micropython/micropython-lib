# Tests for the Buffer class included in usb.device.impl
#
# The easiest way to run this is using unix port. From the top-level usb-device directory,
# run as:
#
# $ micropython -m tests.test_impl_buffer
#
import micropython
from usb.device import impl
from impl import Buffer

if not hasattr(impl.machine, "disable_irq"):

...
def main(args):
    ...
    parser.add_argument(
        "-l", "--lines", type=int, default=1, help="\tnumber of lines for each week (default 1)"
    )
    parser.add_argument(
        "-s", "--spacing", type=int, default=6, help="\tspacing between months (default 6)"
    )
    parser.add_argument("-m", "--months", type=int, default=3, help="\tmonths per row (default 3)")
    parser.add_argument("-c", "--css", default="calendar.css", help="\tCSS to use for page")
